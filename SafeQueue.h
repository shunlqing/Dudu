#ifndef DUDU_SAFEQUEUE_H
#define DUDU_SAFEQUEUE_H
...
size_t SafeQueue<T>::size() {
    std::lock_guard<std::mutex> lk(*this); //SafeQueue继承自std::mutex，所以属于BasicLockable
    return items_.size();
}
